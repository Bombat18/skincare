...
const BestSellers = () => {
    ...
    return (
        <div ref={sectionRef} className="bg-[#FAFDF4] px-4 sm:px-8 py-16">
            {/* Header */}
            <div className="flex flex-col  lg:flex-row md:flex-col lg:items-center   justify-start md:justify-start lg:justify-between max-w-6xl mx-auto mb-12">
                <button className="flex w-60 items-center gap-2 px-5 py-2 rounded-full border border-gray-400 text-gray-900 font-medium ">
                    <span className="w-3 h-3 rounded-full bg-gray-900"></span>
                    Best Selling Products
                </button>

                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-medium text-[#2D3B36] mt-6 sm:mt-0 text-left  lg:text-center">
                    Skincare That Brings Out <br /> Your Natural Radiance
                </h2>

                {/* Arrows */}
                <div className=" hidden lg:flex  gap-3 mt-6 sm:mt-0">
                    <button
                        onClick={handlePrev}
